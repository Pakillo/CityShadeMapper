test_that("calc_shade works", {
  ...
  expect_equal(round(terra::values(shaderas), digits = 2),
               structure(c(0.88, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88, 0.88,
                           ...
                           0.88, 0.88, 0.88, 0.88, 0.88), dim = c(81L, 1L), dimnames = list(
                             NULL, "lyr.1"))
  )
